  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out ${
        scrolled
          ? 'bg-white/[0.03] backdrop-blur-xl border-b border-white/10 py-2 md:py-3'
          : 'bg-transparent py-4 md:py-6'
      }`}>
        <div className="relative max-w-[1800px] mx-auto px-4 md:px-6 flex items-center justify-between">
          ...
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
            <Link href="/" className="flex items-center gap-2 md:gap-3 group">
              <div className="relative w-3 h-3 md:w-4 md:h-4 border border-white/40 rotate-45 flex items-center justify-center group-hover:border-white transition-colors">
                <div className="w-0.5 h-0.5 md:w-1 md:h-1 bg-white" />
              </div>
              <span className="text-sm md:text-lg lg:text-xl font-normal tracking-tight text-white uppercase whitespace-nowrap">
                Kvell Dynamics
              </span>
            </Link>
          </div>
          ...
          <div className="flex items-center">
            <Link href="/contact" className="flex items-center gap-2 md:gap-3 px-3 md:px-5 py-2 md:py-2.5 bg-white/5 border border-white/10 hover:bg-white/10 transition-all rounded-[2px] group">
              ...
              <span className="hidden sm:inline text-[10px] uppercase tracking-[0.3em] font-semibold text-white">
                contact
              </span>
            </Link>
          </div>
