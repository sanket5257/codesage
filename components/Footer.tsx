      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 md:px-16 lg:px-24 py-16 md:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:hello@codesage.com" className="text-gray-400 hover:text-white transition-colors text-sm">
                  hello@codesage.com
                </a>
              </li>
              <li>
                <a href="tel:+971501234567" className="text-gray-400 hover:text-white transition-colors text-sm">
                  +971 50 123 4567
                </a>
              </li>
